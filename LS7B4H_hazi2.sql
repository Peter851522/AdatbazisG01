DROP TABLE IF EXISTS Ugyfel_Maszk;

CREATE TABLE Ugyfel_Maszk
(
	[LOGIN] varchar(100),
	EMAIL varchar(100) MASKED WITH (FUNCTION = 'email()'),
	NEV varchar(100) MASKED WITH (FUNCTION = 'partial(1,"XXXX",1)'),
	SZULEV int MASKED WITH (FUNCTION = 'random(1,500)'),
	NEM char,
	CIM varchar(100),
);

INSERT INTO Ugyfel_Maszk
...
('AGNESK','AGNESK@gmail.com','Kovács Ágnes',1988,'N','1084 Budapest, Endrõdi Sándor utca 47.'),
('akos','ákos.bíró@mail.hu','Bíró Ákos',1982,'F','9023 Gyõr, Kossuth Lajos utca 47/b.'),
('aladar','aladár.dunai@mail.hu','Dunai Aladár',1980,'F','5931 Nagyszénás, Árpád utca 23.'),
('alexandra','alexandra.bagóczki@mail.hu','Bagóczki Alexandra',1992,'N','2381 Táborfalva, Petõfi utca 1/2.'),
('alexis','alexbiro@gmail.com','Biró Alexander',2000,'F','6914 Pitvaros, Deák F. u. 38.'),
('andi','andrea.maródi@mail.hu','Maródi Andrea',1968,'N','5465 Cserkeszõlõ, Árpád utca 4.'),
('andras2','andrás.tóth@mail.hu','Tóth András',1997,'F','4071 Egyek, Petõfi utca 30.'),
...
('andras4','andras4@gmail.com','Back András',1984,'F','3783 Edelény, Fõ út 169.'),
('andras41','andras41@gmail.com','Komjáti András',1997,'F','5065 Nagykörû, Kossuth út 24.'),
('ANDRASE','ANDRASE@gmail.com','Erdei András',1997,'F','5071 Besenyszög, Szolnoki út 8.'),
('ANDRASN','andrás.nagy@mail.hu','Nagy András',1980,'F','6500 Baja, Fõ út 169.'),
('andrea','andrea.kiss@mail.hu','Kiss Andrea',1993,'N','1113 Budapest, Petõfi Sándor utca 87.'),
...
('anett3','anett.pivarcsi@mail.hu','Pivarcsi Anett',1967,'N','1149 Budapest, Fõ út 60.'),
('aniko','aniko@gmail.com','Tóth Anikó',1973,'N','2085 Pilisvörösvár, Deák Ferenc út 5.'),
('aniko4','aniko4@gmail.com','Böröcz Anikó',1978,'N','2484 Agárd, Petõfi Sándor tér 1.'),
...
('annamaria1','annamária.szûcs@mail.hu','Szûcs Annamária',1990,'N','1191 Budapest, Rendeki utca 21.'),
('ANNAMARIAR','ANNAMARIAR@gmail.com','Regõs Annamária',1977,'N','8283 Káptalantóti, Petõfi Sándor tér 1.'),
('aron2','aron2@gmail.com','Jakab Áron',1971,'F','7133 Fadd, Bajcsy-Zsilinszky utca 4.'),
('ARONK','áron.kelemen@mail.hu','Kelemen Áron',1989,'F','8200 Veszprém, Petõfi utca 8.'),
...
('balazs2','balázs.szûcs@mail.hu','Szûcs Balázs',1984,'F','3170 Szécsény, Szabadság utca 95.'),
('balazs3','balazs3@gmail.com','Bakódy Balázs',1986,'F','2131 Göd, Arany János utca 1.'),
('balint','balint@gmail.com','Horváth Bálint',1996,'F','6646 Tömörkény, Endrõdi Sándor utca 47.'),
('balint1','balint1@gmail.com','Molnár Bálint',1989,'F','9181 Kimle, Fõ út 169.'),
('balint2','balint2@gmail.com','Vukasinovity Bálint',1997,'F','2330 Dunaharaszti, Béke utca 7.'),
('balu','bálint.endresz@mail.hu','Endresz Bálint',1976,'F','3973 Cigánd, Fõ út 169.'),
...
('BELAF','BELAF@gmail.com','Farkas Béla',1995,'F','5530 Vésztõ, Petõfi Sándor utca 3.'),
('bence','bence@gmail.com','Gyõrffy Bence',1987,'F','6900 Makó, Árpád utca 23.'),
('BENCEB','bence.bajusz@mail.hu','Bajusz Bence',1973,'F','8391 Sármellék, Fõ utca 56.'),
('bernadett1','bernadett1@gmail.com','Simon Bernadett',1984,'N','2300 Ráckeve, Fõ utca 108.'),
('bernadett2','bernadett.kovács@mail.hu','Kovács Bernadett',1996,'N','4200 Hajdúszoboszló, Fõ út 122.'),
('BERNADETTO','bernadett.orbán@mail.hu','Orbán Bernadett',1987,'N','5085 Rákóczifalva, Arany János utca 1.'),
('bertalan','bertalan@gmail.com','Csiger Bertalan',1977,'F','1192 Budapest, Fõ út 169.'),
('brigitta','brigitta.székely@mail.hu','Székely Brigitta',1978,'N','2462 Martonvásár, Fõ utca 47.'),
...
('david','david@gmail.com','Ambrus Dávid',1974,'F','1149 Budapest, Fõ út 18.'),
...
('debora','debóra.barna@mail.hu','Barna Debóra',1976,'N','1155 Budapest, Fõ út 169.'),
('denes','denes@gmail.com','Tömböly Dénes',1975,'F','2400 Dunaújváros, Kossuth út 39.'),
('desdemona','mor.otto@mail.hu','Mór Ottó',1968,'F','9200 Mosonmagyaróvár Fõ u. 12.'),
('dora3','dóra.sarodi@mail.hu','Sarodi Dóra',1995,'N','2855 Bokod, Fõ út 18.'),
('edit','edit.bittmann@mail.hu','Bittmann Edit',1984,'N','6077 Orgovány, Fõ utca 60.'),
('emese','emese.kuruc@mail.hu','Kuruc Emese',1989,'N','6700 Szeged, Rákóczi utca 67.'),
('eszter','eszter.molnár@mail.hu','Molnár Eszter',1987,'N','6800 Hódmezõvásárhely, Fõ út 77.'),
...
('eva','eva@gmail.com','Enyedi Éva',1967,'N','4231 Bököny, Petõfi utca 8.'),
...
('gabor4','gábor.telek@mail.hu','Telek Gábor',1987,'F','9071 Görbeháza, Fõ út 169.'),
('GABORS','GABORS@gmail.com','Szöllõsi Gábor',1990,'F','3630 Putnok, Kossuth utca 27.'),
...
('gusztav','gusztav@gmail.com','Bárci Gusztáv',1967,'F','3643 Dédestapolcsány, Endrõdi Sándor utca 47.'),
('GYONGYIK','gyöngyi.kornseé@mail.hu','Kornseé Gyöngyi',1974,'N','8800 Nagykanizsa, Fõ út 60.'),
...
('IBOLYAA','ibolya.andor@mail.hu','Andor Ibolya',1983,'N','9023 Gyõr, Posta köz 2.'),
('ilona3','ilona3@gmail.com','Bosnyák Ilona',1990,'N','2483 Gárdony, Posta köz 2.'),
('imre','imre.búza@mail.hu','Búza Imre',1988,'F','9181 Kimle, Petõfi Sándor tér 1.'),
...
('ISTVANV','ISTVANV@gmail.com','Varga István',1989,'F','6320 Solt, Hõsök tere 11.'),
('janos3','janos3@gmail.com','Harangozó János',1967,'F','8700 Marcali, Petõfi Sándor tér 1.'),
...
('jozsef','jozsef@gmail.com','Gergely József',1985,'F','6050 Lajosmizse, Fõ út 18.'),
('jozsef2','józsef.vajda@mail.hu','Vajda József',1978,'F','6700 Szeged, Baracsi László utca 14.'),
('JOZSEFG','józsef.gyuris@mail.hu','Gyuris József',1975,'F','2660 Balassagyarmat, Petõfi utca 1/2.'),
('JUDITH','JUDITH@gmail.com','Hídasi Judit',1997,'N','2100 Gödöllõ, Fõ út 169.'),
...
('kanita12','anita.kiss12@gmail.com','Kiss Anita',1975,'N','2230 Gyömrõ Fõ tér 3.'),
('kata','katalin.gondos@mail.hu','Gondos Katalin',1968,'N','8237 Tihany, Kossuth Lajos utca 6.'),
('katalin','katalin.horváth@mail.hu','Horváth Katalin',1968,'N','2424 Elõszállás, Rákóczi út 200.'),
...
('katka','katalin.kovács@mail.hu','Kovács Katalin',1975,'N','8254 Kõvágóörs, Petõfi utca 22.'),
('klaudia2','klaudia.bakó@mail.hu','Bakó Klaudia',1982,'N','8254 Kõvágóörs, Kossuth Lajos utca 6.'),
...
('krisztina1','krisztina.bori@mail.hu','Bori Krisztina',1969,'N','2115 Vácszentlászló, Fõ utca 47.'),
...
('laszlo2','lászló.móra@mail.hu','Móra László',1975,'F','9970 Szentgotthárd, Petõfi utca 1/2.'),
...
('marton','marton@gmail.com','Kalacsi Márton',1989,'F','5137 Jászkisér, Fõ út 169.'),
...
('MATYASS','mátyás.szilágyi@mail.hu','Szilágyi Mátyás',1975,'F','9023 Gyõr, Kossuth Lajos utca 6.'),
('melissza','nagy_peter@indamail.hu','Nagy Péter',1998,'F','6800 Hódmezõvásárhely, Oldalkosát u. 1.'),
('MIHALYJ','mihály.juhász@mail.hu','Juhász Mihály',1979,'F','6786 Ruzsa, Rákóczi utca 1.'),
('miklos2','miklos2@gmail.com','Gondos Miklós',1995,'F','2100 Gödöllõ, Árpád utca 23.'),
...
('NANDORF','nándor.fõ@mail.hu','Fõ Nándor',1968,'F','5920 Csorvás, Bécsi utca 82.'),
('nikolett3','nikolett3@gmail.com','Horváth Nikolett',1981,'N','1072 Budapest, Arany János utca 1.'),
('nikoletta4','nikoletta4@gmail.com','Kõ Nikoletta',1972,'N','5537 Zsadány, Fõ út 18.'),
('NIKOLETTAT','nikoletta.tatár@mail.hu','Tatár Nikoletta',1997,'N','1067 Budapest, Gyõri utca 12.'),
('norbert','norbert@gmail.com','Szûcs Norbert',1969,'F','5071 Besenyszög, Gyõri utca 12.'),
('norbert2','norbert.hegedûs@mail.hu','Hegedûs Norbert',1991,'F','2081 Piliscsaba, Rendeki utca 21.'),
...
('polla','polla@gmail.com','Palágyi Polla',1994,'N','2484 Agárd, Fõ út 18.'),
('rajmond4','rajmond.rácz@mail.hu','Rácz Rajmond',1993,'F','9155 Lébény, Petõfi utca 1/2.'),
('reka4','réka.szikszai@mail.hu','Szikszai Réka',1969,'N','8254 Kõvágóörs, Templom utca 73.'),
...
('ROBERTI','róbert.iván@mail.hu','Iván Róbert',1967,'F','2377 Örkény, Petõfi Sándor utca 3.'),
('ROBERTP','ROBERTP@gmail.com','Pásztor Róbert',1972,'F','5137 Jászkisér, Ady Endre út 27.'),
('roland','roland@gmail.com','Tóth Roland',1968,'F','2000 Szentendre, Fõ út 169.'),
('roland1','roland.ferencz@mail.hu','Ferencz Roland',1985,'F','2424 Elõszállás, Fõ út 169.'),
...
('sandor4','sandor4@gmail.com','Nagy Sándor',1997,'F','4600 Kisvárda, Fõ utca 47.'),
...
('SZABOLCSM','szabolcs.miklós@mail.hu','Miklós Szabolcs',1980,'F','1102 Budapest, Fõ út 169.'),
('SZILARDS','szilárd.szalai@mail.hu','Szalai Szilárd',1967,'F','1077 Budapest, Fõ út 18.'),
...
('TAMASF','TAMASF@gmail.com','Fényes Tamás',1997,'F','9023 Gyõr, Arany János utca 1.'),
...
('tihamer','tihamér.kazy@mail.hu','Kazy Tihamér',1991,'F','2370 Dabas, Fõ utca 60.'),
...
('tunde','tunde@gmail.com','Turcsik Tünde',1974,'N','7130 Tolna, Fõ út 122.'),
...
('vivien3','vivien3@gmail.com','Boros Vivien',1991,'N','2117 Isaszeg, Fõ út 122.'),
('zoltan','zoltán.fodor@mail.hu','Fodor Zoltán',1979,'F','3441 Mezõkeresztes, Fõ utca 23.'),
('zoltan4','zoltan4@gmail.com','Barna Zoltán',1986,'F','8313 Balatongyörök, Jászai tér 21.'),
('ZOLTANP','zoltán.pintér@mail.hu','Pintér Zoltán',1977,'F','6050 Lajosmizse, Fõ út 18.'),
...
('zsolt1','zsolt.pulai@mail.hu','Pulai Zsolt',1988,'F','8391 Sármellék, Fõ utca 60.'),
...
DROP USER IF EXISTS FELHASZNALO;
CREATE USER FELHASZNALO WITHOUT LOGIN;
GRANT SELECT ON Ugyfel_Maszk TO FELHASZNALO;
